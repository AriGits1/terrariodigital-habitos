...
INSERT INTO "new_Profile" ("biomeType", "createdAt", "email", "hapticsEnabled", "id", "name", "onboarded", "passwordHash", "role", "updatedAt", "voiceEnabled") SELECT "biomeType", "createdAt", "email", "hapticsEnabled", "id", "name", "onboarded", "passwordHash", "role", "updatedAt", "voiceEnabled" FROM "Profile";
DROP TABLE "Profile";
